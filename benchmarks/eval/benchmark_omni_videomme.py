...
| ---------- | --------------------------- | -------- | --------- | ------ | ----------- | ------------------------------------------------------------------------- |
| Qwen3-Omni | thinker-only, full-set, c=4 | 64.30%   | 1605/2496 | 0      | 77          | dirty ca87d3f [H200, c=4, max_tokens=256]                                 |
...
| ---------- | --------------------------- | --------- | ------ | -------------- | ---------------- | ------------- | ------------- | -------------- | ------------- | --------------- | ---------------- | ------------------ | ------------------- | -------------- | ------------------------------------------------------------------------- |
| Qwen3-Omni | thinker-only, full-set, c=4 | 2496      | 0      | 19.478         | 19.903           | 23.638        | 27.131        | 6.0            | 5.9           | 115.0           | 287606           | 13769.0            | 34366523            | 0.205          | dirty ca87d3f [H200, c=4, max_tokens=256]                                 |
"""
