...
MOSS_TD_CER_PERCENT_REF = 5.859921189780095
MOSS_TD_CER_NO_SPK_PERCENT_REF = 5.859921189780095
MOSS_TD_CER_NO_SPK_BELOW_50_PERCENT_REF: float | None = 4.980387113368915
MOSS_TD_N_ABOVE_50_CER_REF: int | None = 30
MOSS_TD_CP_CER_PERCENT_REF = 13.078365323503242
MOSS_TD_CER_NO_SPK_CP_VALID_PERCENT_REF = 5.859921189780095
MOSS_TD_DELTA_CER_PERCENT_REF = 7.2661116054404475
MOSS_TD_SPEAKER_TIMESTAMP_DER_PERCENT_REF: float | None = 20.983861175458113
MOSS_TD_CER_VALID_SAMPLES_MIN: int | None = 784
MOSS_TD_CP_CER_VALID_SAMPLES_MIN: int | None = 784
MOSS_TD_THROUGHPUT_QPS_REF = 40.376
MOSS_TD_LATENCY_MEAN_S_REF = 0.321
MOSS_TD_LATENCY_P95_S_REF = 0.672
MOSS_TD_RTF_MEAN_REF = 0.0351
MOSS_TD_RTF_P95_REF = 0.0444

AISHELL4_LONG_CER_PERCENT_REF = 13.847279662050537
AISHELL4_LONG_CER_NO_SPK_PERCENT_REF = 13.847279662050537
AISHELL4_LONG_CP_CER_PERCENT_REF = 14.080673237906222
AISHELL4_LONG_DELTA_CER_PERCENT_REF = 0.24448115665642867
AISHELL4_LONG_SPEAKER_TIMESTAMP_DER_PERCENT_REF = 9.835029194130067
AISHELL4_LONG_THROUGHPUT_QPS_REF = 0.069
AISHELL4_LONG_LATENCY_MEAN_S_REF = 158.451
AISHELL4_LONG_LATENCY_P95_S_REF = 204.153
AISHELL4_LONG_RTF_MEAN_REF = 0.0693
AISHELL4_LONG_RTF_P95_REF = 0.0905
...
GOOGLETIME_CER_PERCENT_REF = 33.14012598406427
GOOGLETIME_CER_NO_SPK_PERCENT_REF = 33.14012598406427
GOOGLETIME_CER_NO_SPK_BELOW_50_PERCENT_REF: float | None = 31.96167041113117
GOOGLETIME_N_ABOVE_50_CER_REF: int | None = 1
GOOGLETIME_CP_CER_PERCENT_REF = 33.95216896405819
GOOGLETIME_DELTA_CER_PERCENT_REF = 0.8255114750385872
GOOGLETIME_SPEAKER_TIMESTAMP_DER_PERCENT_REF = 31.357643045842963
GOOGLETIME_THROUGHPUT_QPS_REF = 0.048
GOOGLETIME_LATENCY_MEAN_S_REF = 249.119
GOOGLETIME_LATENCY_P95_S_REF = 272.309
GOOGLETIME_RTF_MEAN_REF = 0.0966
GOOGLETIME_RTF_P95_REF = 0.1244
...
MOSS_TD_STREAM_CER_PERCENT_REF: float | None = 5.850387695436634
MOSS_TD_STREAM_CER_NO_SPK_PERCENT_REF: float | None = 5.850387695436634
MOSS_TD_STREAM_CER_NO_SPK_BELOW_50_PERCENT_REF: float | None = 4.970741431419201
...
MOSS_TD_STREAM_CP_CER_PERCENT_REF: float | None = 13.19594508707258
MOSS_TD_STREAM_CER_NO_SPK_CP_VALID_PERCENT_REF: float | None = 5.850387695436634
MOSS_TD_STREAM_DELTA_CER_PERCENT_REF: float | None = 7.345557391635945
MOSS_TD_STREAM_SPEAKER_TIMESTAMP_DER_PERCENT_REF: float | None = 21.007143993916966
MOSS_TD_STREAM_CER_VALID_SAMPLES_MIN: int | None = 784
MOSS_TD_STREAM_CP_CER_VALID_SAMPLES_MIN: int | None = 784
MOSS_TD_STREAM_THROUGHPUT_QPS_REF: float | None = 42.764
MOSS_TD_STREAM_LATENCY_MEAN_S_REF: float | None = 0.302
MOSS_TD_STREAM_LATENCY_P95_S_REF: float | None = 0.621
MOSS_TD_STREAM_RTF_MEAN_REF: float | None = 0.0329
MOSS_TD_STREAM_RTF_P95_REF: float | None = 0.0412
MOSS_TD_STREAM_TEXT_TTFT_P95_S_REF: float | None = 0.0545
MOSS_TD_STREAM_INTER_CHUNK_P95_S_REF: float | None = 0.0637
